...
/**
 * Testdata is taken from https://github.com/OWASP/owasp-mstg
...
public class ApplicationInfoServiceTest {
	...
	public void testApplicationMetaInfo(String fileName, String applicationName, String versionName, String versionCode)
	{
		ApplicationInfo appInfo = target.getAppInfo(ApplicationInfoServiceTest.class.getClassLoader().getResource(fileName).getFile());
