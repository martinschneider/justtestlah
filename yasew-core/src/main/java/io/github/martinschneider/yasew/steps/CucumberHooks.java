...
public class CucumberHooks {
	...
	public void restartDriver() {
		...
		if (configuration.isEyesEnabled()) {
			...
			eyes.open(WebDriverRunner.getWebDriver(), configuration.getApplicationName(), configuration.getPlatform());
		}
	}
	...
	public void shutdown() throws IOException {
		...
		if (configuration.isGalenEnabled()) {
			...
			new HtmlReportBuilder().build(galenTests,
					"target/galen-html-reports/" + LocalDate.now().format(DateTimeFormatter.BASIC_ISO_DATE));
		}
	}
}
