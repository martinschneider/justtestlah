package io.github.martinschneider.justtestlah.aop;
...
public class EntryExitLoggingAspect implements MethodInterceptor {
  ...
  /**
   * this is the entry point for advices configured in {@link
   * io.github.martinschneider.justtestlah.aop.AopConfig}
   */
