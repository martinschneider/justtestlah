...
public class JustTestLahRunnerTest {
  ...
  public void testBuildCucumberOptions() throws InitializationError, IOException {
    ...
    assertThat(target.buildCucumberOptions())
        ...
        .isEqualTo(
            "--tags @web --tags @regression --glue io.github.martinschneider.justtestlah.steps  --glue com.test --plugin pretty --plugin html:report --plugin json:target/report/cucumber/cucumber.json src/test/resources/features --strict");
  }
}
