 ...
 * 
 * We inject all page objects. This way it is not necessary to annotate them
 * with {@link org.springframework.beans.factory.annotation.Autowired}.
 * 
...
public class Base implements ApplicationContextAware {
	...
	/**
	 * inject the page objects (without
